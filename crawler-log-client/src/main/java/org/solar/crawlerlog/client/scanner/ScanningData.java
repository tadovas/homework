...
public class ScanningData {
  ...
  private static final List<String> availableUrls =
      Arrays.asList("www.imdb.com", "www.delfi.lt", "panele.lt", "cosmopolitan.com");
  ...
  private static final List<String> availableOccupations =
      Arrays.asList(
          "Actor",
          "Singer",
          "Scandalist",
  ...
  public static Collection<Celebrity> scrappedCelebrities() {
    ...
    for (int i = 0; i < celebritiesToGenerate; i++) {
      celebrities.add(new Celebrity(pickOne(availableNames), pickOne(availableOccupations)));
    }
    return celebrities;
  }
