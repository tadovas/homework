...
public class ConcurrentHashMapRepositoryQueryTest {
  ...
  public void shouldReturnListOfUnfinishedJobsForUrl() {
    ...
    Collection<CrawlerLog> result =
        repository.findAllUnfinishedForSourceUrl(SourceUrl.fromString("url1"));
  ...
  public void shouldReturnAllFinishedJobsMatchingUrl() {
    ...
    assertThat(result, contains(hasProperty("id", equalTo(LogId.fromString("2")))));
  }
