...
public class ConcurrentHashMapRepositoryTest {
  ...
  public void savedCrawlerLogShouldBeFoundById() {
    ...
    concurrentHashMapRepository.save(
        CrawlerLog.newCrawlerLog(LogId.fromString("id1"), SourceUrl.fromString("url1")));
    concurrentHashMapRepository.save(
        CrawlerLog.newCrawlerLog(LogId.fromString("id2"), SourceUrl.fromString("url2")));
