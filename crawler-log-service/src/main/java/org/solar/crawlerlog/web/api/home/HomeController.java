...
public class HomeController {
  ...
  public ApiDescription getApiDescription() throws Exception {
    ...
    ApiDescription apiDescription =
        new ApiDescription(
            "Greetings human/machine. Below you will find a list of apis which could fit your needs. Choose wisely");

    apiDescription.add(
        linkTo(methodOn(CrawlerLogController.class).createNewCrawlerLog(null))
            .withRel("crawler-logs"));
    ...
    apiDescription.add(
        BasicLinkBuilder.linkToCurrentMapping()
            ...
            .withRel("Swagger-ui-human-eyes-only"));
